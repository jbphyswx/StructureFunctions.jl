...
Test.@testset "Shorthands Verification" begin
    ...
    res2 = SF.calculate_structure_function(
        :L2SF,
        x,
        u,
        bins;
    ...
    res2v = SF.calculate_structure_function(
        Val(:L2SF),
        x,
        u,
        bins,
    ...
    Test.@inferred SF.calculate_structure_function(
        Val(:L2SF),
        x,
        u,
        bins,
    ...
    res3 = SF.calculate_structure_function(
        2,
        :longitudinal,
        x,
        u,
    ...
    res3v = SF.calculate_structure_function(
        Val(2),
        Val(:long),
        x,
        u,
    ...
    res4 =
        SF.StructureFunction(2, :long, x, u, bins; verbose = false, show_progress = false)
    ...
    Test.@inferred SF.StructureFunction(
        Val(2),
        Val(:long),
        x,
        u,
    ...
    Test.@test SF.S2SF(x, u, bins; verbose = false, show_progress = false) isa
               SF.StructureFunction
    Test.@test SF.T3SF(x, u, bins; verbose = false, show_progress = false) isa
               SF.StructureFunction
end
