...
"""
function calculate_structure_function(X::Vector, Y::Vector, values::Vector, distance_bins::Vector{Tuple{FT,FT}}; order=2, distance_metric=Distances.Euclidean()) where FT
...
function calculate_structure_function(X::Vector, Y::Vector, values::Vector, distance_bins::Int; order=1, distance_metric=Distances.Euclidean()) where FT
"""
